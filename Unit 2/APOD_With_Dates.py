...
date_year = input("Type a year from 1995 or later; ->")
date_month = input("Type in a month between 1-12; ->")
date_day = input("Type in a day between 1-31; ->")


date_to_search = "&date=" + date_year + "-" + date_month + "-" + date_day
